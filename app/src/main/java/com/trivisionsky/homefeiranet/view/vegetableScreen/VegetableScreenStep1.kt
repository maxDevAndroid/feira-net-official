package com.trivisionsky.homefeiranet.view.vegetableScreen
...
@Preview(showBackground = true, name = "EmulatorPreview")
@Composable
fun FeiraNetVegetableAppPreview() {
    FeiraNetVegetableScreen()
}

@Composable
fun FeiraNetVegetableScreen() {
    Scaffold(
        topBar = { TopBar() },
...
@Composable
fun ProductItem(product: ProductVegetable) {
...
val products = listOf(
    ProductVegetable("Milho", 6.00, 5, R.drawable.ic_corn),
    ProductVegetable("Cenoura", 3.00, 2, R.drawable.ic_carrot),
    ProductVegetable("Brocolis", 20.00, 15, R.drawable.ic_broccoli),
    ProductVegetable("Tomate", 8.00, 5, R.drawable.ic_tomato)
)

data class ProductVegetable(val name: String, val price: Double, val und: Int, val imageRes: Int)
